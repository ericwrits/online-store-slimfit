					...
					<div class="col-sm-6 ">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href=""><i class="fa fa-phone"></i> +234 81616 90804</a></li>
								<li><a href=""><i class="fa fa-envelope"></i> ezehnzube@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="index.php"><img src="assets/front/images/home/loglo.png" alt="" /></a>
						</div>
